...
export default function SignupTalent() {
  ...
  const handleSignup = () => {
    ...
    // Navigate to talent skill form after successful signup
  ...
  const handleLogin = () => {
    // Navigate to the talent login page
      ...
      >
        <View className="flex-1 px-6 pt-12 pb-8">
          ...
          <View className="mb-8">
            ...
            <Text className="text-xl text-black">Create your Kwiyeh Talent account</Text>
          </View>
